...
const serviceOptions = [
  {
    ...
    image: {
      src: "https://firebasestorage.googleapis.com/v0/b/studio-2610147525-49407.firebasestorage.app/o/resmokeonlinebooking_pwa%2Fimages%2Fservices_repairs_electrical%2Fservices_repairs_electrical_onsite.PNG?alt=media&token=8208829e-70a2-4be4-aec9-df7828ee1fe5",
  ...
  },
  {
    ...
    image: {
      src: "https://firebasestorage.googleapis.com/v0/b/studio-2610147525-49407.firebasestorage.app/o/resmokeonlinebooking_pwa%2Fimages%2Fservices_repairs_electrical%2Fservices_repairs_electrical_workshop.PNG?alt=media&token=db0fc957-f98c-4c95-baba-ab33e9f55a01",
  ...
  },
  {
    ...
    features: [
      ...
      (
        <span>
          Small Items (e.g., Motors) – Hand-carryable electrical items:<br />
      ...
      (
        <span>
          Large Items (e.g., Machinery) – Bulky electrical goods requiring trolley/extra handling:<br />
          &nbsp;&nbsp; <span className="text-green-500 font-semibold">R550 (Centurion Area)</span><br />
          &nbsp;&nbsp; <span className="text-orange-500 font-semibold">R650+ (Outside Centurion Area)</span>
        </span>
      ),
    ...
    image: {
      src: "https://firebasestorage.googleapis.com/v0/b/studio-2610147525-49407.firebasestorage.app/o/resmokeonlinebooking_pwa%2Fimages%2Fservices_repairs_electrical%2Fservices_repairs_electrical_workshop_collection.PNG?alt=media&token=b3ea6065-f6b1-42ff-baf9-da63cf5e3866",
  ...
  return (
    <BookingFlowLayout>
      <div className="text-center mb-16">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground uppercase">ELECTRICAL REPAIRS</h1>
