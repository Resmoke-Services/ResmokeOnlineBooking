...
const serviceOptions = [
  {
    ...
    description: "Our technician comes directly to your home or office for consultation, installation, and setup.",
    features: [
      ...
      (
        <span>
          Callout fee applies based on location (Excludes Hardware, Labour & Additional Fees):<br />
    ...
    image: {
      src: "https://firebasestorage.googleapis.com/v0/b/studio-2610147525-49407.firebasestorage.app/o/resmokeonlinebooking_pwa%2Fimages%2Fservices_automation%2Fservices_home_automation_onsite.PNG?alt=media&token=f5b90b15-890d-47b2-b909-a44b523bb5cc",
...
export default function ServicePage() {
  ...
  return (
    <BookingFlowLayout>
      <ServiceSelectionTracker selections={["AUTOMATION", "HOME"]} />
      <div className="text-center mb-16">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground uppercase">HOME AUTOMATION</h1>
