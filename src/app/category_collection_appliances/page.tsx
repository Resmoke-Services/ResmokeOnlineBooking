...
export default function ServicePage() {
  ...
  return (
    <BookingFlowLayout>
      <ServiceSelectionTracker selections={["COLLECTION", "APPLIANCES"]} />
      <div className="text-center mb-16">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground uppercase">APPLIANCE COLLECTION</h1>
