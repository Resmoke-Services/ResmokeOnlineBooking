...
const serviceOptions = [
  {
    ...
    description: 'Bring your vehicle to our workshop for a comprehensive diagnostic scan.',
    features: [
      'Full system scan and fault report.',
      'Card/EFT/PayShap Payments accepted.',
      'Drop off at our Centurion workshop.',
      (
        <span>
          Diagnostic Scan Fee:<br />
          &nbsp;&nbsp; <span className="text-green-500 font-semibold">R550 (All Vehicles)</span>
        </span>
      ),
      'Full payment shall be made prior to the release of any vehicle from the workshop.'
    ],
    image: {
...
export default function ServicePage() {
  ...
  return (
    <BookingFlowLayout>
      <ServiceSelectionTracker selections={["DIAGNOSTICS", "AUTOMOTIVE"]} />
      <div className="text-center mb-16">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground uppercase">AUTOMOTIVE DIAGNOSTICS</h1>
