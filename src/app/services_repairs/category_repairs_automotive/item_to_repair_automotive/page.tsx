...
const baseAutomotiveRepairItems = [
    { id: 'VEHICLE', label: 'VEHICLE', note: 'Specify make and model in description' },
    { id: 'MOTORCYCLE', label: 'MOTORCYCLE', note: 'Specify make and model in description' },
] as const;
...
export default function AutomotiveItemToRepairPage() {
  ...
  const [repairItemsList, setRepairItemsList] = useState<RepairItem[]>([...baseAutomotiveRepairItems]);
  ...
  async function onSubmit(data: ItemToRepairFormData) {
    ...
    // This page is now part of the full booking flow and should proceed to the next step.
