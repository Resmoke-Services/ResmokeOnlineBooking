...
const baseApplianceItems = [
    ...
    { id: 'CAMPING FRIDGE', label: 'CAMPING FRIDGE'},
    { id: 'AIR FRYER', label: 'AIR FRYER'},
    { id: 'COFFEE MACHINE', label: 'COFFEE MACHINE'},
    { id: 'ICE MACHINE', label: 'ICE MACHINE'},
    { id: 'SNAPPY CHEF', label: 'SNAPPY CHEF'},
    { id: 'SMEG KETTLE', label: 'SMEG KETTLE'},
    { id: 'SMEG TOASTER', label: 'SMEG TOASTER'},
    { id: 'VACUUM CLEANER', label: 'VACUUM CLEANER'},
] as const;
...
export default function ApplianceItemToAssessPage() {
  ...
  const [assessmentItemsList, setAssessmentItemsList] = useState<AssessItem[]>([...baseApplianceItems]);
    ...
    <BookingFlowLayout>
      <Card className="shadow-xl">
        <CardHeader>
          ...
          <CardDescription>Select the appliance(s) for the damage report and describe the damage.</CardDescription>
        </CardHeader>
        <Form {...form}>
